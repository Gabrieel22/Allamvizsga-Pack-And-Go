...
const App = () => {
  ...
  const searchFlights = async () => {
    ...
    const url = `http://localhost:3000/flight-search?originCode=${origin}&destinationCode=${destination}&dateOfDeparture=${departureDate}${
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        // Handle flight data and navigation
      } else {
